        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <label 
              ...
              className={`block text-sm font-medium transition-colors duration-300 ${
                isFocused.name ? 'text-blue-500' : theme.text.secondary
              }`}
            >
              Name
            </label>
            <input
              ...
              className={`mt-1 block w-full px-3 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 transition-all duration-300 
                ...
                ${theme.input.text}
                ${theme.input.focus}
                ${isFocused.name ? 'ring-2 ring-blue-300' : ''}`}
              required
            />
          </div>
          <div>
          ...
          <div>
            <label 
              htmlFor="userType" 
              className={`block text-sm font-medium transition-colors duration-300 ${
                isFocused.userType ? 'text-blue-500' : theme.text.secondary
              }`}
            >
              User Type
            </label>
            <select
              ...
              className={`mt-1 block w-full px-3 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 transition-all duration-300 
                ...
                ${theme.input.text}
                ${theme.input.focus}
                ${isFocused.userType ? 'ring-2 ring-blue-300' : ''}`}
              required
            >
